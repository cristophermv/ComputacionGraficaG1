...
class CasaClotilde {
private:
    // Función para dibujar un cubo con textura de color
    ...
    // Función para dibujar las paredes exteriores amarillas
    void drawWalls() {
        ...
        // Techo
// Ahora más pequeño, no sobresale
drawColoredCube(0.0f, 3.0f, 0.0f, 5.8f, 0.2f, 5.8f, 0.9f, 0.9f, 0.9f);
    }

    // Función para dibujar una puerta exterior mirando hacia afuera
    ...
    // Función para dibujar ventana exterior mirando hacia afuera
    ...
    // Función para dibujar el sofá verde con patrón floral
    void drawSofa() {
        // Base del sofá
    ...
    // Función para dibujar una lámpara
    void drawLamp(float x, float y, float z) {
        ...
        // Pantalla de la lámpara (amarilla/beige)
        glPushMatrix();
    ...
    // Función para dibujar cuadros en la pared
    ...
    // Función para dibujar objetos decorativos en la mesa
...
public:
    ...
    // Función principal para renderizar toda la casa
    void render() {
        glPushMatrix();
    ...
    // Función para renderizar solo el exterior (si quieres optimizar)
    void renderExterior() {
        glPushMatrix();
        drawWalls();
        drawExteriorDoor();
    ...
    // Función para renderizar solo el interior
    void renderInterior() {
        glPushMatrix();
        drawSofa();
        drawTable(1.5f, 0.0f, 0.0f, 1.0f, 0.7f, 0.6f);
    ...
    // Función para renderizar con transformaciones personalizadas
