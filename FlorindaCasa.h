...
public:
    ...
    // Método principal para dibujar toda la casa
    void dibujar() {
    ...
    // Método para inicializar la iluminación (opcional)
    ...
    // Método para dibujar la casa con escala específica
    ...
    // Método para dibujar la casa con rotación
    ...
    // Método completo con transformaciones
